...
<body class="index-page sidebar-collapse">
  ...
  <div class="main main-raised">
    <div class="container">
      ...
      <!-- debut section présentation des resultats de la recherche -->
      <div class="section section-formations" id="resultat-recherche">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            <h2 class="text-center title">Résultat de la recherche</h2>
            <h4 class="text-center description">Nombre d'éléments retrouvés (3)</h4>
            <div class="list-group" id="cours">
              <a id="resultat1" href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                  <h4> <i class="fa fa-tag"></i> <strong class="text-warning"> Resultat 1</strong> </h4>
                </div>
              ...
              <a id="formation1" href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                  <h4> <i class="fa fa-tag"></i> <strong class="text-warning"> Resultat 2</strong> </h4>
                </div>
                <p>Debut du descriptif de l'actualité avec quelques lignes sommaires ... </p>
                <span class="text-info">Cliquer pour voir le détail</span>
              </a>
              <a id="formation1" href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                  <h4> <i class="fa fa-tag"></i> <strong class="text-warning"> Resultat 3</strong> </h4>
                </div>
                <p>Debut du descriptif de l'actualité avec quelques lignes sommaires ... </p>
                <span class="text-info">Cliquer pour voir le détail</span>
              </a>
      ...
      <!-- fin section présentation des resultats de la recherche -->
  ...
  $("#resultat1").click(function(e) {
    e.preventDefault();
    $("#detail-resultat1").toggle('slow');
  });
  </script>
