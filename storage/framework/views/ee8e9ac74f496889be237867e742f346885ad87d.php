...
<?php echo app('translator')->get('headings.actualites'); ?>
  ...
  <div class="entete">
    ...
    <div id="navbar-collapse-02" class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a class="scroll" href="<?php echo e(url('actualites')); ?>"><?php echo app('translator')->get('menus.actualites'); ?></a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12 text-center">
        <h2><?php echo app('translator')->get('headings.actualites'); ?> </h2>
        <p>Les actualités</p>
      </div>
    </div>
