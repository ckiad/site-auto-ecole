  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12 text-center">
        <h2><?php echo app('translator')->get('headings.initialisation_mot_passe'); ?> </h2>
    ...
    <div class="row">
      <div class="col-md-offset-4 col-md-4 col-sm-12 col-xs-12 ">
        ...
        <div class="contact-form">
          <form class="clearfix" accept-charset="utf-8" method="post" action="<?php echo e(url('forgotpassword')); ?>" autocomplete="off">
            <?php echo e(csrf_field()); ?>

            <div class="row">
              <div class="col-sm-12 form-group wow fadeInDown" data-wow-delay="700ms" data-wow-duration="1000ms">
                <label class="sr-only">Email Address</label>
                <input type="email" name="email" placeholder="<?php echo app('translator')->get('labels.adresse_mail'); ?> *" value="<?php echo old('email'); ?>" class="form-control input-lg" required="">
                <span class="help-block"><?php echo e($errors->first('email', ':message')); ?></span>
              </div>
            </div>

            <!-- submit button -->
            <button class="btn btn-success btn-lg btn-block wow fadeInDown" data-wow-delay="1200ms" data-wow-duration="1000ms" type="submit"><?php echo app('translator')->get('buttons.initialiser_mot_passe'); ?></button>
            <div class="text-center" style="margin: 10px;">
                <a href="<?php echo e(url('login')); ?>"><?php echo app('translator')->get('links.se_connecter'); ?> </a> <span> <?php echo app('translator')->get('labels.ou'); ?> <?php echo app('translator')->get('labels.souscrire_a'); ?> : </span>
            </div>
          </form>
        </div>

        <div class="text-center lien-souscription">
          <a href="<?php echo e(url('inscription-formation')); ?>"> <img src="<?php echo e(asset('assets/img/panneau_bleu.png')); ?>" alt="formation" style="width:50px; height:50px; margin-right:10px;"> </a>  <a href="<?php echo e(url('inscription-marketing')); ?>"><img src="<?php echo e(asset('assets/img/matrice.png')); ?>" alt="marketing" style="width:100px; height:50px; margin-left:10px;"></a>
        </div>
      </div>
    </div>
  </div>
