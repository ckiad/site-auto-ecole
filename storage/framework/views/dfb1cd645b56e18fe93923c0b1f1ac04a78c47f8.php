...
<!--  href="<?php echo e(asset(' ')); ?>" fin entete-->
  ...
  <div class="wrapper">
    ...
    <div class="sidebar" data-color="purple" data-background-color="black">
      <div class="logo text-center">
        <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Auto Ecole la Vie" style="width:150px; height:40px;">
      </div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li id="menu-accueil" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-home')); ?>">
              <i class="fa fa-wrench"></i>
              <p><?php echo app('translator')->get('menus.espace_personnel'); ?></p>
            </a>
          </li>
          <li id="menu-actualites" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-actualites')); ?>">
          ...
          <li id="menu-formations" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-formations')); ?>">
              <i class="fa fa-graduation-cap"></i>
              <p>Mes formations</p>
            </a>
          </li>
          <li id="menu-cours" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-cours')); ?>">
              <i class="fa fa-book"></i>
              <p>Mes cours</p>
            </a>
          </li>
          <li id="menu-evaluations" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-evaluations')); ?>">
          ...
          <li id="menu-reseau-marketing" class="nav-item ">
            <a class="nav-link" href="<?php echo e(url('user/user-matrice')); ?>">
              <i class="fa fa-sitemap"></i>
              <p>Ma matrice</p>
            </a>
          </li>
          <li id="menu-reseau-marketing" class="nav-item ">
            <a class="nav-link" href="<?php echo e(url('user/user-partenaires')); ?>">
              <i class="fa fa-share-alt"></i>
              <p>Mes partenaires</p>
            </a>
          </li>
          <li id="menu-gadgets" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user-compte-marketing')); ?>">
              <i class="fa fa-money"></i>
              <p>Mon compte marketing</p>
            </a>
          </li>
          <li id="menu-gadgets" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-gadgets')); ?>">
          ...
          <li id="menu-transactions" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-transactions')); ?>">
              <i class="fa fa-exchange"></i>
              <p>Mes transactions</p>
            </a>
          </li>
          <li id="menu-temoignages" class="nav-item">
            <a class="nav-link" href="<?php echo e(url('user/user-temoignages')); ?>">
          ...
          <div class="navbar-wrapper">
            <h1 class="navbar-brand"><strong><?php echo $__env->yieldContent('titre-operation'); ?></strong></h1>
              <!-- debut contenu panneau lien de paiement des souscriptions ou des tranches -->
                <?php echo $__env->yieldContent('lien-paiement'); ?>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fa fa-cog"></i>
                  <p>
                    <span class="d-lg-none d-md-block"><?php echo app('translator')->get('labels.parametres'); ?></span>
                  </p>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="<?php echo e(('edit-profile')); ?>">
...
<script src="<?php echo e(asset('assets/js/jquery.orgchart.min.js')); ?>"></script>
