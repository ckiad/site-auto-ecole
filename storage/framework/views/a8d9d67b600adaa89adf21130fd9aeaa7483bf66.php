        ...
        <div class="contact-form">
          <form class="clearfix" accept-charset="utf-8" method="post" action="<?php echo e(url('/login')); ?>">
            ...
            <div class="text-center" style="margin: 10px;">
                <a href="<?php echo e(url('forgotpassword')); ?>"><?php echo app('translator')->get('links.mot_passe_oublie'); ?> ?</a>
                <span style="font-size:12px;"><?php echo app('translator')->get('labels.ou'); ?> <?php echo app('translator')->get('labels.souscrire_a'); ?> :</span>
            </div>
          </form>
        </div>
