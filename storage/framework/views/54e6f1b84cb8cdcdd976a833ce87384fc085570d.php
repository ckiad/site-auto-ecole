<?php $__env->startSection('titre'); ?>
  <?php echo app('translator')->get('headings.inscription_marketing'); ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-3 col-md-6 col-sm-12 col-xs-12 text-center">
        <h4><?php echo app('translator')->get('headings.inscription_plateforme_marketing'); ?> </h4>
        ...
        <div class="contact-form">
          <form class="clearfix" accept-charset="utf-8" method="post" action="">
            <?php echo e(csrf_field()); ?>
                ...
                <?php if(session('user_mentor')): ?>
                  <h3>Bienvenue et merci d'avoir répondu favorablement à l'invitation de <?php echo e(session('user_mentor')->email); ?></h3>
                  <input type="hidden" name="lien_invitation" id="lien_invitation" class="form-control form-input" value="<?php echo e(session('user_mentor')->id); ?>">
                <?php endif; ?>
